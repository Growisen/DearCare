  ...
  return (
    <ModalPortal>
      <div className="fixed inset-0 bg-gray-900/40 backdrop-blur-sm z-50 flex items-center justify-center p-4 animate-in fade-in duration-200">
        ...
        <div className="bg-white border border-slate-200 rounded-sm w-full max-w-3xl flex flex-col max-h-[90vh] overflow-hidden">
          
          <div className="flex items-center justify-between p-6 border-b border-slate-200 bg-gray-50">
            <div>
          ...
          <div className="grid grid-cols-2 gap-px bg-gray-200 border-b border-slate-200">
          ...
          <div className="flex-1 overflow-y-auto bg-white p-6">
            {historyItems.length > 0 ? (
              <div className="space-y-0 divide-y divide-gray-100 border border-slate-200 rounded-sm">
              ...
              <div className="flex flex-col items-center justify-center py-16 text-center border border-slate-200 border-dashed rounded-sm bg-gray-50">
          ...
          <div className="p-4 border-t border-slate-200 bg-gray-50 flex justify-end">
            <button
              onClick={onClose}
              className="px-6 py-2 bg-white border border-slate-200 text-slate-700 font-medium rounded text-sm hover:bg-gray-100 hover:border-slate-200 transition-all"
            >
              Close
            </button>
          </div>
