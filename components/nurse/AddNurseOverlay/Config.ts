export const FORM_CONFIG = {
  ...
  styles: {
    input: "w-full rounded-sm border border-slate-200 py-2 px-3 text-sm text-gray-900 bg-white focus:outline-none focus:border-slate-300 transition duration-200",
