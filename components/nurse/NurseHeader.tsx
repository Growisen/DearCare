        ...
        <div className="flex flex-wrap gap-3 mt-2">
          <div className="flex items-center gap-1.5">
            ...
            <select
              ...
              className="sm:hidden rounded-sm border border-slate-200 bg-white py-1.5 px-2 text-sm 
              text-gray-800 appearance-none focus:outline-none focus:ring-1 focus:ring-blue-400"
              style={{ 
          ...
          <div className="flex items-center gap-1.5">
            ...
            <select
              ...
              className="sm:hidden rounded-sm border border-slate-200 bg-white py-1.5 px-2 text-sm text-gray-800
