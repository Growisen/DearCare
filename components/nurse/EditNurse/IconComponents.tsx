...
// This file contains all the SVGs and the components that render them.
...
export const DocumentIcon = React.memo(({ type }: { type: string }) => {
...
export const FileTypeIcon = React.memo(({ fileName }: { fileName: string }) => {
