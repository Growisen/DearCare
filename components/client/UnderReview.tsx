          ...
          {!showForm ? (
            <div className="flex flex-col items-center justify-center p-10 bg-gray-50 rounded-sm">
              ...
              <div className="w-full max-w-md">
                <div className="mb-6 p-4 bg-green-50 border border-green-200 rounded-sm flex items-center gap-2">
            ...
            <>
              <div className="mb-4">
                <button 
                  ...
                  className="px-4 py-2 text-gray-700 border border-slate-200 rounded-sm hover:bg-gray-100 flex items-center gap-2"
                >
