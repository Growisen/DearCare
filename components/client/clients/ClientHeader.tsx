      ...
      <div className="p-4 bg-gray-50 space-y-3">
        <div className="relative w-full">
          ...
          <button
            ...
            className="absolute right-2 top-1/2 -translate-y-1/2 bg-blue-500 hover:bg-blue-600
             text-white px-2.5 py-1 rounded-sm text-xs transition-colors"
          >
            Search
          </button>
        </div>
        ...
        <div className="hidden sm:flex flex-wrap items-center gap-3">
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            <div className="px-2.5 py-1 rounded-sm text-xs font-medium bg-blue-50 text-blue-700
        ...
        <div className="sm:hidden space-y-2">
          ...
          <button
            ...
            className={`w-full py-1.5 rounded text-xs font-medium transition-colors border flex items-center 
