  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white p-6 rounded-sm shadow-lg w-full max-w-md">
        ...
        <textarea
          className="w-full border border-slate-200 rounded-sm py-2 px-3 text-gray-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent"
        ...
        <div className="flex justify-end gap-3 mt-4">
          <button 
            className="px-4 py-2 text-gray-600 border border-slate-200 rounded-sm hover:bg-gray-50"
            onClick={onClose}
