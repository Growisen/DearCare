...
import { Search, X, Download, Calendar, FilePlus, Loader } from "lucide-react"
    ...
    <div className="bg-gray-50 rounded-sm border border-slate-200 overflow-hidden">
      ...
      <div className="p-4 bg-gray-50 flex flex-col gap-3">
        <div className="flex flex-col gap-2">
          ...
          <div className="relative w-full">
            ...
            <Input
              ...
              className="pl-9 pr-16 py-1 h-9 bg-white text-sm border-slate-200 focus-visible:ring-blue-400 
              text-gray-800 rounded-sm w-full"
              value={searchInput}
        ...
        <div className="flex flex-col sm:flex-row gap-2 w-full items-center">
          ...
          <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto sm:ml-8 items-center">
            ...
            <div className="flex items-center gap-2 mt-2 sm:mt-0">
              <div className="relative flex items-center">
                <Input
                  ...
                  className="px-2 py-0.5 h-7 rounded-sm text-xs font-medium bg-white border border-slate-200 text-gray-800"
                  value={dateFilter}
                ...
                {dateFilter && (
                  <button
                    ...
                    className="absolute right-2 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 p-0.5
                     z-10 rounded-full hover:bg-gray-100"
              ...
              <button
                ...
                className={`px-2 py-0.5 h-7 rounded-sm text-xs font-medium bg-white flex items-center justify-center
                   whitespace-nowrap ${
            ...
            <button
              ...
              className={`px-2.5 py-1 rounded-sm text-xs font-medium transition-colors border flex items-center gap-1 mt-2 sm:mt-0 ${
        ...
        <div className="sm:hidden flex flex-col gap-2 w-full">
          ...
          <select
            ...
            className="w-full rounded-sm border border-slate-200 bg-white py-1.5 px-2 text-sm text-gray-800
             appearance-none focus:outline-none focus:ring-1 focus:ring-blue-400"
            style={{ 
          ...
          <div className="flex items-center gap-2">
            <div className="relative flex items-center w-full">
              <Input
                type="date"
                placeholder="Filter by date"
                className="px-2 py-0.5 h-7 rounded-sm text-xs font-medium bg-white border border-slate-200
