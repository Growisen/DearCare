...
export default function StaffAttendance({ currentTime }: StaffAttendanceProps) {
  ...
  return (
    <Card className="p-3 sm:p-4 bg-white/50 backdrop-blur-sm border border-gray-100/20 rounded-xl min-h-[250px] h-auto col-span-full sm:col-span-2">
      ...
      <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6">
        <div className="relative w-20 h-20 sm:w-24 sm:h-24">
          ...
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center">
            <p className="text-base sm:text-lg font-bold text-gray-900">85%</p>
