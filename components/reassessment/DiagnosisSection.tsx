    ...
    <section className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-6">
        <div className="space-y-1">
          ...
          <textarea id="diagnosis" name="diagnosis" rows={2} value={formData.diagnosis} onChange={onChange} className="w-full border border-gray-200 rounded-sm px-3 py-2 focus:outline-none focus:border-gray-400 transition-colors bg-gray-50 focus:bg-white text-gray-700 placeholder-gray-400 text-sm resize-none" />
        </div>
        <div className="space-y-1">
          <label htmlFor="presentCondition" className="block text-xs font-medium text-gray-500 uppercase">Present Condition</label>
          <textarea id="presentCondition" name="presentCondition" rows={3} value={formData.presentCondition} onChange={onChange} className="w-full border border-gray-200 rounded-sm px-3 py-2 focus:outline-none focus:border-gray-400 transition-colors bg-gray-50 focus:bg-white text-gray-700 placeholder-gray-400 text-sm resize-none" />
        </div>
      </div>
