...
export default function EditableField({ 
  ...
  return (
    <div className="flex flex-col">
      ...
      {!isEditing ? (
        <div className="flex justify-between items-center p-3 bg-white rounded border border-slate-200 hover:border-slate-200 transition-colors">
        ...
        <div className="flex flex-col space-y-3 border border-slate-200 p-3 rounded bg-gray-50">
          <input
            ...
            className="border border-slate-200 rounded p-2.5 focus:outline-none focus:ring-1 focus:ring-gray-400 focus:border-slate-200 text-gray-800"
            disabled={isSaving}
            autoFocus
          />
          <div className="flex space-x-2 justify-end">
            <button
              ...
              className="px-3 py-1.5 text-sm border border-slate-200 rounded hover:bg-gray-100 text-gray-800 flex items-center gap-1.5 transition-colors"
              disabled={isSaving}
            >
              <X className="w-4 h-4" />
              <span>Cancel</span>
