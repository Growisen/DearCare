        ...
        {hasNoDocuments ? (
          <div className="flex flex-col items-center justify-center py-10 text-gray-500">
            <svg className="w-12 h-12 mb-3 text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 17v-2a4 4 0 018 0v2m-8 4h8a2 2 0 002-2v-6a2 2 0 00-2-2H7a2 2 0 00-2 2v6a2 2 0 002 2z" />
            </svg>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {documentsInfo.adhar && (
              <div className="flex items-center p-3 bg-gray-50 rounded-sm border border-slate-200">
                <div className="p-2 bg-red-50 rounded-sm mr-3">
            ...
            {documentsInfo.ration && (
              <div className="flex items-center p-3 bg-gray-50 rounded-sm border border-slate-200">
                <div className="p-2 bg-green-50 rounded-sm mr-3">
            ...
            {documentsInfo.educational && (
              <div className="flex items-center p-3 bg-gray-50 rounded-sm border border-slate-200">
                <div className="p-2 bg-blue-50 rounded-sm mr-3">
            ...
            {documentsInfo.experience && (
              <div className="flex items-center p-3 bg-gray-50 rounded-sm border border-slate-200">
                <div className="p-2 bg-yellow-50 rounded-sm mr-3">
            ...
            {documentsInfo.noc && (
              <div className="flex items-center p-3 bg-gray-50 rounded-sm border border-slate-200">
                <div className="p-2 bg-purple-50 rounded-sm mr-3">
