...
export default function DashboardLayout({
  ...
  return (
    <div className={`min-h-screen bg-gradient-to-br from-[#ebf4f5] to-[#f7f5fa]  ${inter.className}`}>
      ...
      <div className={`relative lg:pl-56 transition-all duration-300 ${isSidebarOpen ? 'lg:filter-none filter blur-sm' : ''}`}>
        <Navbar onMenuClick={() => setSidebarOpen(!isSidebarOpen)} />
        <main className="pt-8 md:pt-12 p-0">
          <div className="pt-6 px-0 m-0 md:px-2 max-w-[1400px]">
            {children}
          </div>
        </main>
      </div>
