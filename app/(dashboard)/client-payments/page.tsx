...
import { fetchPaymentOverview, fetchClientPaymentAggregates } from "@/app/actions/clients/client-payment-records";
...
export default function ClientPaymentsListPage() {
  ...
  useEffect(() => {
    async function loadAggregate() {
      ...
      const result = await fetchClientPaymentAggregates({
  ...
  return (
    <div>
      ...
      <div>
        <PaymentStats data={aggregate} loading={statsLoading} />
